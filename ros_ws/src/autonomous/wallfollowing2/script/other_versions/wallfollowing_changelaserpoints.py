...
def get_scan_as_cartesian(laser_scan):
    ...
    #print('laser_scan:', laser_scan.ranges)

    #print('laser_scan.angle_min:', laser_scan.angle_min)
    #print('laser_scan.angle_max:', laser_scan.angle_max)
    #print('laser_range:', laser_range)
    #print('usable_range:',usable_range)

    if usable_range < laser_range:
        skip_left = int((-laser_scan.angle_min - usable_range / 2 - math.pi/2) / laser_range * ranges.shape[0])  # nopep8
        skip_right = int((laser_scan.angle_max - usable_range / 2 - math.pi/2) / laser_range * ranges.shape[0])  # nopep8
        angles = angles[skip_left:-1 - skip_right]
        ranges = ranges[skip_left:-1 - skip_right]
	
    #print('skip_left:', skip_left)
    #print('skip_right:', skip_right)
    #print('angles:',angles)
    #print('ranges:',ranges)
